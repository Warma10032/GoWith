...
- 数据库：PostgreSQL 16 + PostGIS（落地于 `db/migrations/00{1..5}_*.sql`）。
...
- 5 个 SQL migration 落地（`db/migrations/00{1..5}_*.sql`）
...
| 里程碑                | 状态    | 关键交付                                                                                                             |
| --------------------- | ------- | -------------------------------------------------------------------------------------------------------------------- |
| M0 脚手架 + Mock 闭环 | ✅ 完成 | monorepo、5 migration、API/Worker/AI-Web/Web/Admin 全部可用                                                          |
