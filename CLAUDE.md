...
- Web (`apps/web`) Next.js App Router：首页 / 地图 / 博主 / 详情 / 后台均可用，公共页带 fallback mock 数据
...
| 层 | 选型 | 实现位置 |
| --- | --- | --- |
| 前端 | Next.js 14 (App Router) + React + TypeScript；Tailwind CSS；lucide-react 图标；fallback mock 数据 | `apps/web/` |
